...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default = 'ssd-ppn/frozen_inference_graph.pb', help='Path to frozen TensorFlow graph.')
    parser.add_argument('--output', default = 'ssd-ppn/graph.pbtxt', help='Path to output text graph.')
    parser.add_argument('--config', default = 'ssd-ppn/pipeline.config', help='Path to a *.config file is used for training.')
