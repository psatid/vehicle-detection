...
if __name__ == "__main__":
    ...
    parser.add_argument('--input', default = 'faster-rcnn/frozen_inference_graph.pb', help='Path to frozen TensorFlow graph.')
    parser.add_argument('--output', default = 'faster-rcnn/graph.pbtxt', help='Path to output text graph.')
    parser.add_argument('--config', default = 'faster-rcnn/pipeline.config', help='Path to a *.config file is used for training.')
