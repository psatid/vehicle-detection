...
parser.add_argument('--input', default = 'mask-rcnn/frozen_inference_graph.pb', help='Path to frozen TensorFlow graph.')
parser.add_argument('--output', default = 'mask-rcnn/graph.pbtxt', help='Path to output text graph.')
parser.add_argument('--config', default = 'mask-rcnn/pipeline.config', help='Path to a *.config file is used for training.')
